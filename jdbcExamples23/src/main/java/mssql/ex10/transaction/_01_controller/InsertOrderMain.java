package mssql.ex10.transaction._01_controller;

import java.util.Arrays;
import java.util.Date;
import java.util.List;

import mssql.ex10.transaction._02_model.OrderBean;
import mssql.ex10.transaction._02_model.OrderDao;
import mssql.ex10.transaction._02_model.OrderDaoImpl;
import mssql.ex10.transaction._02_model.OrderItemDAOBean;
...
public class InsertOrderMain {
	...
	public static void main(String args[]) throws Exception{
		...
		//List<OrderItemDAOBean> items2 = Arrays.asList(oiBean1, oiBean2);
